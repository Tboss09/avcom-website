    ...
    {featuredProducts.map(({ img, header, text }) => (
     <div key={uniqid()} className="featuredProducts_product feature">
      ...
      <div className=" w-11/12 mx-auto feature_text ">
       ...
       <Link
        to="/"
        class="pr-12 pl-4 h-12 flex justify-between items-center  bg-header hover:bg-btn
         focus:ring-header focus:ring-offset-header text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2     rounded "
       >
